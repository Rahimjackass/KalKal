            ...
            <div className='w-7/12'>
                ...
                <div className='w-full'>
                    <div className='flex flex-col bg-green-600 border border-transparent w-auto rounded-3xl py-3 mx-3 my-3'>
                        <h1 className='text-lg text-left mb-1.5 pl-3'>What is <b>KalKal?</b></h1>
                        <div className='text-left'>
                            <p className='text-white text-sm px-3'>Bet on cryptocurrencies like a race! Choose, wait, and win. The best-performing crypto takes the grand prize</p>
